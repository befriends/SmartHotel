<%-- 
    Document   : SelectCategoryAndDate
    Created on : 25 Feb, 2017, 4:24:00 PM
    Author     : vishwas
--%>
                    ...
                    <div style="max-height: 400px; overflow-y: scroll;overflow-x: hidden;">
                        ...
                        <form role="form" class="form-horizontal" id="dateform" target="_blank" action="ReportController" method="post"  onkeypress="myFunction()" > 
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control" style="width:210px;" id="categorynm" placeholder="Select Category Name" name="categoryid" autofocus="true" required="">
                            ...
                            <input type="hidden" name="submodule" value="categorydatewise" />
