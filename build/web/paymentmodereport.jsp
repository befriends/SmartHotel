...
<html>
    <head>
        <meta charset="utf-8">
        <title>Payment Mode Date wise Report</title>
        ...
        <div class="container">
            ...
            <div class="container-fluid">
                <div style="margin-left: auto; margin-right: auto; width: 100%; background-color: antiquewhite;">
                    ...
                    <span class="label label-info center-block" style="height:30px;font-size:20px;font-weight:bolder;vertical-align:middle;">Payment Mode - Date Wise Report</span>
                    <div style="max-height: 400px; overflow-y: scroll;overflow-x: hidden;">
                        ...
                        <form role="form" class="form-horizontal" id="dateform" target="_blank" action="ReportController" method="post"  onkeypress="myFunction()" > 
                            <div class="form-group">
                                <label for="dateid" class="control-label col-sm-2">Select Date : </label>
                                <div class="col-sm-8">
                                    <input class="date-picker" type="text"  name="datepicker1" value="" id="demo" placeholder="--- Select Date ---" required=""/><br><br>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="paymentmode" class="control-label col-sm-2">Select Payment Mode : </label>
                                <div class="col-sm-8">
                            ...
                            <input type="hidden" name="submodule" value="paymentmode" />
                        </form>
                    </div>
                </div>
            </div>
