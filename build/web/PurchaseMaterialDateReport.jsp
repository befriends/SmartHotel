...
<div style="text-align: right;font-size: 10px;">Date : <%=date%></div>
        ...
        <div style="font-size: 10px; font-weight: bold;text-align: center;">Purchase Material Report</div>
            ...
            <table style="width: 100%;">
                ...
                <thead>
                    <tr>
                        ...
                        <th style="border-bottom: 1px dashed; text-align: right"">Name </th>
                        <th style="border-bottom: 1px dashed;">Price</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td><%=i + 1%></td>
                        <td style="text-align: right"><%=materialname%></td>
                        <td><%=price%></td>
                        <td><%=quantity%></td>                                                                                
