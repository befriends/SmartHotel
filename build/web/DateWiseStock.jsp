                    ...
                    <div style="max-height: 400px; overflow-y: scroll;overflow-x: hidden;">
                        ...
                        <form role="form" class="form-horizontal" id="dateform" target="_blank" action="ReportController" method="post"  onkeypress="myFunction()" > 
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input class="date-picker" type="text"  name="datepicker" value="" id="datepicker" placeholder="--- Select Date ---" required=""/><br><br>
                                </div>
                            </div>
                            <div class="form-group"> 
                            ...
                            <input type="hidden" name="submodule" value="datewisestock" />
                        </form>
                    </div>
                </div>
            </div>
