...
%>
<%!
    double grandTotal = 0, discountGrandTotal = 0 ,grandTotalAmount=0;
...
//                year = jobj.getString("year");
    ...
    <body>        
        ...
        <div style="font-size: 12px; font-weight: bold;text-align: center;">Weakly Order MenuItem  Reports</div>
...
//                          discountGrandTotal += discount;
                    ...
                    <!--<tr><td colspan="8" style="border-top: 1px dashed; border-bottom: 1px dashed; font-weight: bold; text-align: right;">Total Discount : <%=twoDForm.format(grandTotal - grandTotalAmount)%></td></tr>-->
                   <%} else {
                            %>
                <script>
