<%-- 
    Document   : MonthlyAmountDetails
    Created on : 20 Jan, 2017, 1:53:01 PM
    Author     : sai
--%>
...
<html>
    <head>
        ...
        <title>MonthlySalesReport</title>
        ...
        <div class="container">
            ...
            <div class="container-fluid">
                <div style="margin-left: auto; margin-right: auto; width: 100%; background-color: antiquewhite;">
                    ...
                    <span class="label label-info center-block" style="height:30px;font-size:20px;font-weight:bolder;vertical-align:middle;">Monthly Purchase Report</span>
                    <div style="max-height: 400px; overflow-y: scroll;overflow-x: hidden;">

                        <form role="form" class="form-horizontal" target="_blank" action="ReportController" method="post" id="dateform" onsubmit="return validate()" > 
                            ...
                            <input type="hidden" name="submodule" value="monthlyamountdetails" />
                        </form>
                    </div>
                </div>
