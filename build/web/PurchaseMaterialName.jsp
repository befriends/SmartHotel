                ...
                <div class="container-fluid">
                    ...
                    <div style="margin-left: auto; margin-right: auto; width: 100%; background-color: antiquewhite;">
                        ...
                        %><span style="width: 100%;margin-left: auto;margin-right: auto;"><h3 style="color: crimson;"><%=message%></h3></span><br /><%
                            ...
                            %>
                        <span class="label label-info center-block" style="height:30px;font-size:20px;font-weight:bolder;vertical-align:middle;">Material Name</span>
                        <div>
                            <fieldset style="border:1px solid silver; padding:5px;">
                                <form role="form" id="orderform" class="form-horizontal" target="_blank" action="ReportController" method="post"  onsubmit="return validate()" >
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control" id="materialnm" placeholder="Select Material Name"  name="materialid" autofocus="true" required="">
                                                ...
                                                %>
                                                <option value="<%=jobj.getString("materialid")%>"><%=jobj.getString("materialname")%></option>
                                                <%
                                                    }
                                                %>
                                            </select>
