...
<html>
 ...
 <link rel="stylesheet" href="css/style.css" />
        ...
        function validate() {
                if (document.getElementById("designation").options[document.getElementById("designation").selectedIndex].value == "") {
        ...
        <div class="container">
            ...
            <div class="container-fluid">
                ...
                <div style="margin-left: auto; margin-right: auto; width: 100%; background-color: antiquewhite;">
                    <span class="label label-info center-block" style="height:30px;font-size:20px;font-weight:bolder;vertical-align:middle;">Employee Wise Report</span>
                    <div style="max-height: 400px; overflow-y: scroll;overflow-x: hidden;">
                        ...
                        <form role="form" class="form-horizontal" target="_blank" action="ReportController" method="post"  onkeypress="myFunction()" id="dateform" onsubmit="return validate()"> 
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control" id="designation" placeholder="Select Employee Designation" name="designation" onchange="loadEmployeeName();" autofocus="true" required="">
                            ...
                            <input type="hidden" name="submodule" value="paymentemployee" />
                        </form>
                    </div>
                </div>
                </body>
