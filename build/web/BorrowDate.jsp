<%-- 
    Document   : BorrowDate
    Created on : 29 Nov, 2016, 1:54:16 PM
    Author     : sai
--%>
        ...
        <div class="container">
            ...
            <div class="container-fluid">
                <div style="margin-left: auto; margin-right: auto; width: 100%; background-color: antiquewhite;">
                    ...
                    <span class="label label-info center-block" style="height:30px;font-size:20px;font-weight:bolder;vertical-align:middle;">Borrow Date Wise Report</span>
                    <div style="max-height: 400px; overflow-y: scroll;overflow-x: hidden;">
                        ...
                        <form role="form" class="form-horizontal" id="dateform" target="_blank" action="ReportController" method="post"  onkeypress="myFunction()" > 
                            ...
                            <input type="hidden" name="submodule" value="dailyborrow" />
                        </form>
                    </div>
                </div>
            </div>
